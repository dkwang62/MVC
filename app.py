...
try:
    ...
    # Set initial title/header (will be replaced by the final title after resort selection)
    st.header("Marriott Vacation Club Calculator")
    ...
    # --- START OF CHANGE ---
    # Delete previous titles and use a single combined title/header here
    st.header(f"Marriott Vacation Club: {resort} ({user_mode} Mode)")
    # --- END OF CHANGE ---
