...
try:
    ...
    checkin_date = st.date_input(
        ...
        value=datetime(2025, 10, 6).date()  # Set to today
    )
    ...
    #     )
    adjusted_nights = num_nights  # Use original num_nights as fallback
    ...
    # Removed Ko Olina-specific AP room logic since it's now handled generically
